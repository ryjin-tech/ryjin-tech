  ...
  return (
    <div className={styles.heroContainer}>
      ...
      <video
        ...
        playsInline
      >
        <source src="/bg%20vdo.mp4" type="video/mp4" />
      </video>
      ...
      {/* Sidebar Details */}
      <div className={`${styles.sidebarTop} glass-panel`}>
        <div className={styles.productLabel}>VOIDBLADE</div>
        <div className={styles.productName}>VOIDBLADE MK-I</div>
        <div className={styles.productPrice}>$120</div>
      </div>
